...
useEffect(() => {
  ...
  const trasnaltions = {
    en: {
      ...
      Platea: "Platea habitasse maecenas; suspendisse sociosqu ex lacinia euismod. Facilisi phasellus scelerisque sociosqu per commodo metus. Et sociosqu consectetur nisl etiam quam dapibus vivamus. Class fames pulvinar lobortis ante curae varius lobortis!",
      Dis: "Dis consequat ullamcorper primis vitae imperdiet facilisi. Platea cras tristique pellentesque neque laoreet senectus. Dolor pulvinar sed vel iaculis accumsan risus eu blandit. Adipiscing hac cubilia aliquam mattis vulputate adipiscing viverra.",
      Color: "Color",
